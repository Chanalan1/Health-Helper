...
df = pd.read_csv('training_data/anxiety_year_excluded.csv')

# Features are age groups, sex, race, ethnicity, Target is Diagnosis with ADHD
features = df.drop(columns=['Total Individuals with Diagnosis of Anxiety Disorders'])
target = df['Total Individuals with Diagnosis of Anxiety Disorders']
...
single_individual_data = {
    ...
    'American Indian or Alaska Native': 1,  # Example: Race feature values
    'Asian': 0,
...
print(f"Likelihood of Anxiety diagnosis: {likelihood_of_diagnosis[0]:.2%}")